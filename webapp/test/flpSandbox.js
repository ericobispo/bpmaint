					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Manutenção de Parceiros",
									"targetURL": "#bpmaint08-display"
								}
							}]
						}]
					}
						...
						"inbounds": {
							"bpmaint08-display": {
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bpmaint08",
									"url": sap.ui.require.toUrl("bpmaint08")
								}
							}
						}
					}
